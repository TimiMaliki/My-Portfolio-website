...
import caped from "../img/projects/Caped/caped1.png";
      ...
      <div className="w-full max-w-7xl mx-auto px-1">
          ...
          {projects.map((project, index) => (
            <Link to={project.link}>
              ...
              >
                ...
                {/* Title & Description */}
                <h3 className="text-md md:text-xl font-light md:font-bold mb-2">
                  {project.title}
                </h3>
        ...
        <div className="flex justify-center align-middle py-8">
          <Link to="/projects">
            <Buttons
              color={
                "border shadow-[1.95px_1.95px_2.6px_rgba(0,0,0,0.15)]  hover:bg-red-600 hover:text-white transition-all duration-300"
              }
              textColor={""}
              icons={<FaArrowAltCircleRight className="w-5 h-5 mt-1 " />}
              text={"view more"}
            />
          </Link>
        </div>
